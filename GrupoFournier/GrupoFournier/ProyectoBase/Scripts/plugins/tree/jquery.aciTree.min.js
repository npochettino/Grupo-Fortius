/*****************************************
    CONTROL: Tree
    ARCHIVO: jquery.aciTree.min.js (v4.5.0-rc.7)
...
var svgCarpeta = '<svg version="1.1" id="icoCarpeta" xmlns="http://www.w3.org/2000/svg " xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve"><path d="M416,480l96-256H96L0,480H416zM64,192L0,480V64h144l64,64h208v64H64z"></path></svg>';
// core
(function (d, c, f) {
    var b = {
        ajax: {
    ...
    var e = {
        ...
        init: function (h) {
            ...
            if (this._instance.options.rootData) {
                this.loadFrom(null, this._inner(h, {
                    success: i,
                    fail: g,
                ...
                if (this._instance.options.ajax.url) {
                    this.ajaxLoad(null, this._inner(h, {
                        success: i,
                        fail: g
                    }))
                } else {
        ...
        isOpenPath: function (h) {
            var g = this.parent(h);
            return g[0] ? this.isOpen(g) && a.hasClass(g[0], "aciTreeVisible") : true
        },
        ...
        setVisible: function (h, g) {
            ...
            if (this.isItem(h)) {
                ...
                var i = function () {
                    ...
                    var k = h[0].firstChild;
                    var o = k.getBoundingClientRect();
                    var j = k.offsetHeight;
                    var n = g.center ? (l.bottom - l.top) / 2 : 0;
                    if (o.bottom - j < l.top + n) {
                        ...
                        if (!g.unanimated && this._instance.options.view) {
                            this._instance.jQuery.stop(true).animate({
                                scrollTop: this._instance.jQuery.scrollTop() - m
                            }, {
                            ...
                            this._instance.jQuery.stop(true)[0].scrollTop = this._instance.jQuery.scrollTop() - m;
                            this._success(h, g)
                        }
                    } else {
                ...
                this.append(o, this._inner(i, {
                    success: function (s, q) {
                        ...
                        for (var r = 0; r < q.itemData.length; r++) {
                            ...
                            if (p.open) {
                                this.open(q.items.eq(r), this._inner(q, {
                                    itemData: null,
                                    items: null
                                }))
                            }
        ...
        _createItem: function (h, g) {
            ...
            u.setAttribute("aria-level", g + 1);
            if (h.inode || (h.inode === null)) {
            ...
            s.innerHTML = h.label;
            var l = d(r);
            l.data("itemData" + this._instance.nameSpace, d.extend({}, h, {
                branch: h.branch && h.branch.length
            }));
            return l
        },
        ...
        _createItems: function (m, p, h, k, g, r) {
            var o = [],
                n = c.document.createDocumentFragment();
        ...
        children: function (h, g, i) {
            return d(a.children(h && h[0] ? h[0] : this._instance.jQuery[0], g, i ? null : function (j) {
        ...
        addIcon: function (i, g) {
            ...
            if (this.isItem(i)) {
                ...
                g.oldIcon = k.icon;
                var h = a.childrenByClass(i[0].firstChild, "aciTreeItem");
                var j = a.childrenByClass(h, "aciTreeIcon");
                if (j && k.icon && (g.icon.toString() == k.icon.toString())) {
                    this._notify(i, g)
                } else {
                    if (!j) {
                    ...
                    if (g.icon instanceof Array) {
                        j.className = "aciTreeIcon " + g.icon[0];
                        j.style.backgroundPosition = g.icon[1] + "px " + g.icon[2] + "px"
                    } else {
                        j.className = "aciTreeIcon " + g.icon
                    }
                    k.icon = g.icon;
                    this._success(i, g)
                }
        ...
        setLabel: function (h, g) {
            ...
            if (this.isItem(h)) {
                ...
                if (g.label == g.oldLabel) {
                    ...
                    a.childrenByClass(h[0].firstChild, "aciTreeText").innerHTML = g.label;
                    i.label = g.label;
                    this._success(h, g)
                }
            } else {
        ...
        disable: function (h, g) {
            ...
            if (this.isItem(h)) {
                ...
                if (this.isDisabled(h)) {
                    ...
                    a.addClass(h[0], "aciTreeDisabled");
                    this._success(h, g)
                }
            } else {
                this._fail(h, g)
        ...
        isDisabled: function (g) {
            return g && a.hasClass(g[0], "aciTreeDisabled")
        },
        isDisabledPath: function (g) {
            return a.withClass(this.path(g).toArray(), "aciTreeDisabled").length > 0
        },
        disabled: function (g) {
            return d(a.withClass(g.toArray(), "aciTreeDisabled"))
        },
        enable: function (h, g) {
            ...
            if (this.isItem(h)) {
                ...
                if (this.isDisabled(h)) {
                    a.removeClass(h[0], "aciTreeDisabled");
                    this._success(h, g)
                } else {
                    this._notify(h, g)
                }
        ...
        enabled: function (g) {
            return d(a.withClass(g.toArray(), null, "aciTreeDisabled"))
        },
        hide: function (i, g) {
            ...
            if (this.isItem(i)) {
                ...
                if (this.isHidden(i)) {
                    ...
                    a.addRemoveClass(i[0], "aciTreeHidden", "aciTreeVisible");
                    a.addRemoveClass(this.children(i, true).toArray(), "aciTreeHidden", "aciTreeVisible");
                    var h = this.parent(i);
        ...
        isHidden: function (g) {
            return g && a.hasClass(g[0], "aciTreeHidden")
        },
        isHiddenPath: function (h) {
            var g = this.parent(h);
            return g[0] && a.hasClass(g[0], "aciTreeHidden")
        },
        _updateHidden: function (g) {
            if (this.isHiddenPath(g)) {
                if (!this.isHidden(g)) {
                    a.addClass(g[0], "aciTreeHidden");
        ...
        hidden: function (g) {
            return d(a.withClass(g.toArray(), "aciTreeHidden"))
        },
        _showHidden: function (h) {
            ...
            this.path(h).add(h).each(this.proxy(function (i) {
                var j = d(i);
                if (this.isHidden(j)) {
                    a.removeClass(j[0], "aciTreeHidden");
                    if (this.isOpenPath(j) && (!g || this.isOpen(g))) {
                        a.addClass(j[0], "aciTreeVisible")
                    }
        ...
        isOpen: function (g) {
            return g && a.hasClass(g[0], "aciTreeOpen")
        },
        isClosed: function (g) {
            return g && !a.hasClass(g[0], "aciTreeOpen")
        },
        hasChildren: function (g, h) {
            return this.children(g, false, h).length > 0
        },
        ...
        siblings: function (g, h) {
            return g ? d(a.children(g[0].parentNode.parentNode, false, function (i) {
                return (i != g[0]) && (h || !this.hasClass(i, "aciTreeHidden"))
            })) : d([])
        },
        prev: function (g, h) {
            return g ? d(a.prev(g[0], h ? null : function (i) {
                return !this.hasClass(i, "aciTreeHidden")
            })) : d([])
        },
        next: function (g, h) {
            return g ? d(a.next(g[0], h ? null : function (i) {
                return !this.hasClass(i, "aciTreeHidden")
            })) : d([])
        },
        level: function (h) {
        ...
        getIndex: function (j) {
            if (j && j[0]) {
                if (c.Array.prototype.indexOf) {
                    return c.Array.prototype.indexOf.call(j[0].parentNode.childNodes, j[0])
                } else {
                    var h = j[0].parentNode.childNodes;
        ...
        setIndex: function (i, g) {
            ...
            if (this.isItem(i)) {
                ...
                if (g.index == k) {
                    ...
                    var h = this.parent(i);
                    this._setFirstLast(h.length ? h : null, i.add([j[0], j.get(-1)]));
                    this._setOddEven(h);
                    this._success(i, g)
                }
            } else {
        ...
        isItem: function (g) {
            return g && a.hasClass(g[0], "aciTreeLi")
        },
        _animate: function (j, k, i, l) {
            ...
            if (!i) {
                ...
                if (h) {
                    var g = a.container(j[0]);
                    if (g) {
                        d(g).stop(true, true).animate(h.props, {
                            duration: h.duration,
                            easing: h.easing,
            ...
            d(a.container(j[0])).stop(true, true).toggle(k);
            if (l) {
                l.apply(this)
            }
        },
        first: function (g, h) {
            ...
            return d(a.firstChild(g[0], h ? null : function (i) {
                return !this.hasClass(i, "aciTreeHidden")
            }))
        },
        isFirst: function (h, i) {
            if (h) {
                var g = a.parent(h[0]);
                return this.first(g ? d(g) : null, i)[0] == h[0]
            }
            return false
        },
        last: function (g, h) {
            ...
            return d(a.lastChild(g[0], h ? null : function (i) {
                return !this.hasClass(i, "aciTreeHidden")
            }))
        },
        isLast: function (h, i) {
            if (h) {
                var g = a.parent(h[0]);
                return this.last(g ? d(g) : null, i)[0] == h[0]
            }
            return false
        },
        isBusy: function (g) {
            if (g) {
                return a.hasClass(g[0], "loadingElement")
            } else {
        ...
        _loading: function (g, h) {
            if (g) {
                a.toggleClass(g[0], "loadingElement", h);
                if (h) {
                    g[0].firstChild.setAttribute("aria-busy", true)
                } else {
                    g[0].firstChild.removeAttribute("aria-busy")
                }
            } else {
                if (h) {
                    this._loader(h)
        ...
        _loader: function (g) {
            if (g || this.isBusy()) {
                ...
                a.addClass(this._instance.jQuery[0], "loadingElement");
                c.clearTimeout(this._private.loaderHide);
                this._private.loaderHide = c.setTimeout(this.proxy(function () {
                    a.removeClass(this._instance.jQuery[0], "loadingElement")
        ...
        sameParent: function (i, g) {
            if (i && g) {
                var j = this.parent(i);
                var h = this.parent(g);
                return (!j.length && !h.length) || (j[0] == h[0])
            }
            return false
        },
        ...
        destroy: function (g) {
            ...
            this._private.locked = true;
            this._instance.jQuery.addClass("loadingElement").attr("aria-busy", true);
            ...
            this.unload(null, this._inner(g, {
                success: this.proxy(function () {
                    ...
                    this._instance.jQuery.removeClass("aciTree" + this._instance.index + " loadingElement").removeAttr("role aria-busy");
                    this._private.locked = false;
                    this._super();
                ...
                fail: function () {
                    this._instance.jQuery.removeClass("loadingElement");
                    this._private.locked = false;
                    this._trigger(null, "destroyfail", g);
                    this._fail(null, g)
                }
...
//La siguiente linea se comento para que permite seleccionar padres e hijos por separados
//Para que funcione correctamente se debe agregar la propiedad isRadio="true" en el control
...
(function (e, c, f) { var b = { radio: false, radioChain: true, radioBreak: true, radioClick: false }; var d = { _radioInit: function () { this._instance.jQuery.bind("acitree" + this._private.nameSpace, function (k, i, j, g, h) { switch (g) { case "loaded": if (j) { i._radioLoad(j) } break } }).bind("keydown" + this._private.nameSpace, this.proxy(function (h) { switch (h.which) { case 32: if (this.extSelectable && this.extSelectable() && !h.ctrlKey) { var g = this.focused(); if (this.hasRadio(g) && this.isEnabled(g)) { if (!this.isChecked(g)) { this.check(g) } h.stopImmediatePropagation(); h.preventDefault() } } break } })).on("click" + this._private.nameSpace, ".aciTreeItem", this.proxy(function (h) { if (!this._instance.options.radioClick || e(h.target).is(".aciTreeCheck")) { var g = this.itemFrom(h.target); if (this.hasRadio(g) && this.isEnabled(g) && (!this.extSelectable || !this.extSelectable() || (!h.ctrlKey && !h.shiftKey))) { if (!this.isChecked(g)) { this.check(g) } h.preventDefault() } } })) }, _initHook: function () { if (this.extRadio()) { this._radioInit() } this._super() }, _itemHook: function (h, i, g, k) { if (this.extRadio()) { var j = this.extCheckbox && this.hasCheckbox(i); if (!j && (g.radio || ((g.radio === f) && (!this.extCheckbox || !this.extCheckbox())))) { this._radioDOM.add(i, g) } } this._super(h, i, g, k) }, _radioDOM: { add: function (k, g) { a.addClass(k[0], g.checked ? ["aciTreeRadio", "aciTreeChecked"] : "aciTreeRadio"); var l = a.childrenByClass(k[0].firstChild, "aciTreeText"); var j = l.parentNode; var i = c.document.createElement("LABEL"); var h = c.document.createElement("SPAN"); h.className = "aciTreeCheck"; i.appendChild(h); i.appendChild(l); j.appendChild(i); k[0].firstChild.setAttribute("aria-checked", !!g.checked) }, remove: function (i) { a.removeClass(i[0], ["aciTreeRadio", "aciTreeChecked"]); var j = a.childrenByClass(i[0].firstChild, "aciTreeText"); var g = j.parentNode; var h = g.parentNode; h.replaceChild(j, g); i[0].firstChild.removeAttribute("aria-checked") }, check: function (g, h) { a.toggleListClass(g.toArray(), "aciTreeChecked", h, function (i) { i.firstChild.setAttribute("aria-checked", h) }) } }, _radioLoad: function (g) { if (!this._instance.options.radioChain) { return } if (this.hasRadio(g)) { if (this.isChecked(g)) { if (!this.radios(this.children(g, false, true), true).length) { this._radioUpdate(g, true) } } else { this._radioUpdate(g) } } }, _radioChildren: function (h) { if (this._instance.options.radioBreak) { var i = []; var j = this.proxy(function (l) { var k = this.children(l, false, true); k.each(this.proxy(function (m) { var n = e(m); if (this.hasRadio(n)) { i.push(m); j(n) } }, true)) }); j(h); return e(i) } else { var g = this.children(h, true, true); return this.radios(g) } }, _radioLevel: function (g) { var h = []; g.each(this.proxy(function (j) { var k = e(j); var i = this.children(k, false, true); i.each(this.proxy(function (l) { var m = e(l); if (!this._instance.options.radioBreak || this.hasRadio(m)) { h.push(l) } }, true)) }, true)); return e(h) }, _radioUpdate: function (i, j) { var k = this.proxy(function (l) { var m = this.siblings(l, true); this._radioDOM.check(this.radios(m), false); m.each(this.proxy(function (n) { var o = e(n); if (!this._instance.options.radioBreak || this.hasRadio(o)) { this._radioDOM.check(this._radioChildren(o), false) } }, true)) }); if (j) { k(i) } }, hasRadio: function (g) { return g && a.hasClass(g[0], "aciTreeRadio") }, addRadio: function (h, g) { g = this._options(g, "radioadded", "addradiofail", "wasradio", h); if (this.isItem(h)) { if (!this._trigger(h, "beforeaddradio", g)) { this._fail(h, g); return } if (this.hasRadio(h)) { this._notify(h, g) } else { var i = function () { this._radioDOM.add(h, {}); this._success(h, g) }; if (this.extCheckbox && this.hasCheckbox(h)) { this.removeCheckbox(h, this._inner(g, { success: i, fail: g.fail })) } else { i.apply(this) } } } else { this._fail(h, g) } }, removeRadio: function (h, g) { g = this._options(g, "radioremoved", "removeradiofail", "notradio", h); if (this.isItem(h)) { if (!this._trigger(h, "beforeremoveradio", g)) { this._fail(h, g); return } if (this.hasRadio(h)) { this._radioDOM.remove(h); this._success(h, g) } else { this._notify(h, g) } } else { this._fail(h, g) } }, isChecked: function (g) { if (this.hasRadio(g)) { return a.hasClass(g[0], "aciTreeChecked") } if (this._super) { return this._super(g) } return false }, check: function (h, g) { if (this.extRadio && this.hasRadio(h)) { g = this._options(g, "checked", "checkfail", "waschecked", h); if (!this._trigger(h, "beforecheck", g)) { this._fail(h, g); return } if (this.isChecked(h)) { this._notify(h, g) } else { this._radioDOM.check(h, true); if (this._instance.options.radioChain) { this._radioUpdate(h, true) } this._success(h, g) } } else { if (this._super) { this._super(h, g) } else { this._trigger(h, "checkfail", g); this._fail(h, g) } } }, uncheck: function (h, g) { if (this.extRadio && this.hasRadio(h)) { g = this._options(g, "unchecked", "uncheckfail", "notchecked", h); if (!this._trigger(h, "beforeuncheck", g)) { this._fail(h, g); return } if (this.isChecked(h)) { this._radioDOM.check(h, false); if (this._instance.options.radioChain) { this._radioUpdate(h, false) } this._success(h, g) } else { this._notify(h, g) } } else { if (this._super) { this._super(h, g) } else { this._trigger(h, "uncheckfail", g); this._fail(h, g) } } }, radios: function (g, h) { if (h !== f) { return e(a.withClass(g.toArray(), h ? ["aciTreeRadio", "aciTreeChecked"] : "aciTreeRadio", h ? null : "aciTreeChecked")) } return e(a.withClass(g.toArray(), "aciTreeRadio")) }, _serialize: function (g, i) { var h = this._super(g, i); if (h && this.extRadio()) { if (h.hasOwnProperty("radio")) { h.radio = this.hasRadio(g); h.checked = this.isChecked(g) } else { if (this.hasRadio(g)) { if (this.extCheckbox && this.extCheckbox()) { h.radio = true } h.checked = this.isChecked(g) } } } return h }, serialize: function (h, j, k) { if (j == "radio") { var i = ""; var g = this.children(h, true, true); this.radios(g, true).each(this.proxy(function (l) { var m = e(l); if (k) { i += k.call(this, m, j, this.getId(m)) } else { i += this._instance.options.serialize.call(this, m, j, this.getId(m)) } }, true)); return i } return this._super(h, j, k) }, extRadio: function () { return this._instance.options.radio }, option: function (g, h) { if (this.wasInit() && !this.isLocked()) { if ((g == "radio") && (h != this.extRadio())) { if (h) { this._radioInit() } else { this._radioDone() } } } this._super(g, h) }, _radioDone: function (g) { this._instance.jQuery.unbind(this._private.nameSpace); this._instance.jQuery.off(this._private.nameSpace, ".aciTreeItem"); if (!g) { this.radios(this.children(null, true, true)).each(this.proxy(function (h) { this.removeRadio(e(h)) }, true)) } }, _destroyHook: function (g) { if (g) { this._radioDone(true) } this._super(g) } }; aciPluginClass.plugins.aciTree = aciPluginClass.plugins.aciTree.extend(d, "aciTreeRadio"); aciPluginClass.defaults("aciTree", b); var a = aciPluginClass.plugins.aciTree_dom })(jQuery, this);
